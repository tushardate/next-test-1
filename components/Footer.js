export default function Footer() {
  return (
    <div className="bg-gray-900 text-gray-400 font-tdsans text-sm md:text-base px-4 md:px-24 w-full pb-2 md:py-4 text-center md:text-left xs:flex justify-between items-end">
