...
export default function Header() {
  ...
  return (
    <nav className="mx-auto font-tdspace text-gray-900 text-md px-8 fixed z-50 top-0 left-0 right-0 list-none w-full mt-8 flex justify-between">
      <div className="">
      ...
      <div className="flex justify-center items-center">
        {links.map((link) => (
          <div key={link.name} className="pl-10 text-xl">
