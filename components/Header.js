...
export default function Header() {
  ...
  return (
    <nav className="mx-auto font-tdsans font-medium text-gray-900 text-md px-4 sm:px-8 md:px-12 xl:px-24 fixed z-50 top-0 left-0 right-0 list-none w-full mt-6 md:mt-12 flex justify-between">
      <div className="">
        <Link href={"/"} scroll={false}>
          <a className="">
            <div className="flex justify-center items-end">
              <div className="w-5 h-5 md:w-6 md:h-6 mr-4">
